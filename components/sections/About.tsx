      ...
      <div className="relative max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative inline-block">
            <div className="bg-gradient-to-r from-yellow-900/80 via-amber-800/60 to-yellow-900/80 backdrop-blur-sm p-4 rounded-2xl border-2 border-yellow-400/50 shadow-2xl shadow-yellow-400/30">
            ...
            <div className="bg-black backdrop-blur-sm border border-gray-700 rounded-xl p-6 h-full hover:border-yellow-600/50 hover:shadow-xl hover:shadow-yellow-400/10 transition-all duration-300 group">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {categories.map((category, index) => (
                  <span
                    key={index}
                    className="bg-gradient-to-r from-yellow-600/20 to-amber-600/20 text-yellow-300 px-3 py-1 rounded-full text-sm border border-yellow-600/30 hover:border-yellow-400/60 transition-all duration-300 cursor-pointer"
                  >
                    {category}
                  </span>
                ))}
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.2 }}
          variants={{cardVariants}}
          className="bg-black mb-12 backdrop-blur-sm border border-gray-700 rounded-xl p-4 h-full hover:border-yellow-600/50 hover:shadow-xl hover:shadow-yellow-400/10 transition-all duration-300"
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {eventHighlights.map((highlight, index) => (
              <motion.div
                ...
                className="text-center hover:transform hover:scale-110 transition-transform duration-300 bg-gradient-to-br from-yellow-900/20 to-amber-900/20 rounded-lg p-2 border border-yellow-700/30 hover:border-yellow-500/50"
              >
                <div
        ...
        >
          ...
          <div className="relative z-10">
            <div className="hidden md:flex items-center justify-between gap-6">
              ...
              >
                <div className="p-1 bg-black rounded-full h-full w-full">
                  <img
        ...
        <motion.div
          ...
          variants={{cardVariants}}
          custom={0.4}
          className="bg-gradient-to-r from-yellow-900/20 to-amber-900/20 backdrop-blur-sm border border-yellow-600/30 rounded-xl p-6 sm:p-8 hover:border-yellow-400/60 hover:shadow-xl hover:shadow-yellow-400/10 transition-all duration-300"
        >

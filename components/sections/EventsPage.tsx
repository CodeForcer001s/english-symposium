...
// Motion variants with faster durations
const cardVariants = {
...
const coordinatorVariants = {
  ...
  visible: (delay: number = 0) => ({
    ...
    transition: {
      ...
      delay: delay * 0.1, // Reduced from 0.2
    },
  }),
};
      ...
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16">
          ...
          <div className="space-y-8 sm:space-y-12">
            {/* Contact Information */}
            <motion.div
              custom={0.15} // Faster delay start
              variants={cardVariants}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
            ...
            {/* Location Map */}
            <motion.div
              custom={0.25} // Faster delay start
              variants={cardVariants}
              initial="hidden"
              whileInView="visible"
              viewport={{ once: true, amount: 0.3 }}
        ...
        {/* QR Code and Social Media Section */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 mt-8 sm:mt-12 md:mt-16">
          <motion.div
            custom={0.2} // Faster delay start
            variants={cardVariants}
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true, amount: 0.3 }}
            className="group shadow-2xl flex flex-col items-center justify-center gap-6 bg-black/90 backdrop-blur-md border-2 sm:border-4 border-orange-500/60 rounded-2xl sm:rounded-3xl p-8 hover:shadow-orange-400/60 hover:border-orange-400/80 transition-all duration-500 hover:scale-[1.02]"
          >
